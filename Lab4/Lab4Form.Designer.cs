...
namespace Лабораторная_1
{
    partial class Lab4Form
    {
        ...
        private void InitializeComponent()
        {
			...
			// buttonSearch
			// 
			this.buttonSearch.Location = new System.Drawing.Point(783, 28);
			...
			this.groupBox2.Location = new System.Drawing.Point(597, 57);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new System.Drawing.Size(261, 57);
			this.groupBox2.TabIndex = 29;
			this.groupBox2.TabStop = false;
			this.groupBox2.Text = "Выбор цветовой модели";
			// 
			// button1
			// 
			...
			this.radioButton3.Location = new System.Drawing.Point(73, 28);
			this.radioButton3.Name = "radioButton3";
			this.radioButton3.Size = new System.Drawing.Size(46, 17);
			this.radioButton3.TabIndex = 2;
			this.radioButton3.TabStop = true;
			this.radioButton3.Text = "HLS";
			...
			this.inputPictureBox.TabIndex = 25;
			...
			this.button3.Text = "Выполнить расчёт";
			...
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(168, 83);
			...
			this.groupBox1.Location = new System.Drawing.Point(597, 120);
			this.groupBox1.Name = "groupBox1";
			this.groupBox1.Size = new System.Drawing.Size(261, 167);
			this.groupBox1.TabIndex = 38;
			this.groupBox1.TabStop = false;
			this.groupBox1.Text = "Расчет текстурных признаков на основе гистограммных статистик";
			// 
			// button7
			// 
			...
			this.radioButton6.Text = "однородность";
			this.radioButton6.UseVisualStyleBackColor = true;
			// 
			// radioButton5
			// 
			this.radioButton5.AutoSize = true;
			this.radioButton5.Location = new System.Drawing.Point(9, 87);
			this.radioButton5.Name = "radioButton5";
			this.radioButton5.Size = new System.Drawing.Size(120, 17);
			this.radioButton5.TabIndex = 38;
			this.radioButton5.TabStop = true;
			this.radioButton5.Text = "относит.гладкость";
			...
			this.radioButton4.Text = "моменты 2го порядка";
			...
			this.label2.Text = "Выбрать признак:";
			// 
			// groupBox3
			// 
			...
			this.groupBox3.Location = new System.Drawing.Point(597, 410);
			this.groupBox3.Name = "groupBox3";
			this.groupBox3.Size = new System.Drawing.Size(261, 137);
			this.groupBox3.TabIndex = 40;
			this.groupBox3.TabStop = false;
			this.groupBox3.Text = "Генерация наборов особых точек";
			// 
			// textBox4
			// 
			...
			this.radioButton9.Location = new System.Drawing.Point(19, 74);
			...
			this.radioButton8.Location = new System.Drawing.Point(19, 31);
			this.radioButton8.Name = "radioButton8";
			this.radioButton8.Size = new System.Drawing.Size(102, 17);
			this.radioButton8.TabIndex = 0;
			this.radioButton8.TabStop = true;
			this.radioButton8.Text = "метод Харриса";
			...
			this.groupBox4.Location = new System.Drawing.Point(597, 293);
			this.groupBox4.Name = "groupBox4";
			this.groupBox4.Size = new System.Drawing.Size(261, 97);
			this.groupBox4.TabIndex = 41;
			this.groupBox4.TabStop = false;
			this.groupBox4.Text = "Текстурные карты Лавса";
			// 
			// label7
			// 
			...
			// textBox5
			// 
			this.textBox5.Location = new System.Drawing.Point(57, 62);
			...
			this.groupBox5.Location = new System.Drawing.Point(597, 553);
			this.groupBox5.Name = "groupBox5";
			this.groupBox5.Size = new System.Drawing.Size(261, 113);
			this.groupBox5.TabIndex = 42;
			this.groupBox5.TabStop = false;
			this.groupBox5.Text = "Применение метода Хафа для поиска линий и окружностей на контурном представлении";
			// 
			// textBox6
			// 
			...
			this.button9.Text = "Сформировать контурное представление (метод Робертса)";
